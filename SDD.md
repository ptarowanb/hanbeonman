...
| 저장소 구성 | pnpm workspace | `apps/web`, `apps/recorder`, `packages/contracts`, `packages/connectors` |
...
| --- | --- | --- | --- | --- |
| T-01 공통 기반 | workspace, 웹 초기 화면, 이벤트·명세·상태 검증, CI | 없음 | 타입·허용 동작·참조 거부, 빌드·모바일 화면 | 진행 중 |
| T-02 제작자와 버전 | Supabase 인증, 소유권, 초안 저장, 불변 발행 | T-01, Supabase 연결 | AC-03·06·07의 소유자/버전 범위 | 예정 |
| T-03 공개 조회·기록 | 실제 API 계약, 데모/실제 구분, Chrome 기록 | T-01, TAGO 키 | AC-01·09·10·14·16 | 예정 |
| T-04 사진 도구 | 기기 내 변환·ZIP, 의미 있는 연산 기록 | T-01 | AC-11·12·14 | 예정 |
