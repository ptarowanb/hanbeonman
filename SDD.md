...
| 버전 | 1.3 |
| 작성일 | 2026-09-10 |
| 상태 | TAGO 시간표·코드 조회 API와 전체 터미널·등급 드롭다운·검색·반복 버튼 화면, Open-Meteo 날씨 조회, Supabase MVP 저장 스키마 구현. 자연어 버튼 생성의 명세·보안 경계와 단계별 구현 계획을 추가했으며 Gemini 해석 API·버튼 영속 저장·제품 성능과 사업 가설은 미검증 |
...
| T-05 AI 생성·검토 | 자연어·기록별 명세 초안, 누락 필드 질문, 고정/변수 편집, 수신자 미리보기 | T-02·03·04, Gemini 키 | AC-02~05·18~21 | 자연어 계약·보안 경계 문서화. 구현 예정 |
